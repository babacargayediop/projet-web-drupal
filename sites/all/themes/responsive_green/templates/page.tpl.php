...
<div id="header_wrapper">
  ...
  <header id="header" role="banner">
	<div id="top-menu">
		<ul id="top-menu-left">
			<?php print render($page['top_menu_gauche']);?>	
		</ul>		
		<?php if ($display): ?>
         <div id="socialbar">
            <ul class="social">
		...
		<ul id="top-menu-right">
			<?php print render($page['top_menu_droite']);?>
		</ul>
    ...
    <div id="home-slider">
      <div class="flexslider-container">
        <div id="single-post-slider" class="flexslider">
          <!-- /slides -->
		  <div id="info">
		  <h2 class="titre_a_la_une">A la une</h2>
		  <div id="flux-info">
			<p>ceci represente les titres des actualites a la une ce master a pour la prise de hauteur et de recule d'un ecosysteme </p>
            <p>ceci represente les titres des actualites a la une ce master  </p>
            <p>ceci represente les titres des actualites a la une ce master  </p>
            <p>ceci represente les titres des actualites a la une ce master </p>
			</div>
			<div class="class-resume" id="id-resume">
				Toute l'actualite
			</div>
		  </div>
        </div><!-- /flexslider -->
    ...
    <div id="content">
     ...
     <?php if ($is_front):?>   
		<div class="bloc-general">
			<div  class="bloc-grande-ligne class-resume">> Mon Orientation</div>							
				<div id="flux-orientation">
				
					<?php print render($page['bloc_info1']);?>
					<?php print render($page['bloc_info2']);?>	
					<?php print render($page['bloc_info3']);?>	
					<?php print render($page['bloc_recherche']);?>
			</div>
		</div>		
	<?php endif ?>
		<!-- rubrique s'ouvrir a l'etranger -->
		<?php if ($is_front):?> 
			<div  class="bloc-general">
				<div class="bloc-grande-ligne class-resume">> S'ouvrir a l'etranger</div>	
					<div id="flux-international">
						<?php print render($page['international1']);?>
						<?php print render($page['international2']);?>
						<?php print render($page['international3']);?>
				</div>
			</div>	
		<?php endif ?>
		...
		<?php if ($is_front):?> 
		<div  class="bloc-general">
		<div class="bloc-grande-ligne class-resume">> Mes revisions</div>
			<div id="flux-revision">
				<?php print render($page['recherche_examen']);?>
				<?php print render($page['revision1']);?>
				<?php print render($page['revision1']);?>	
				<?php print render($page['revision2']);?>
				<?php print render($page['revision2']);?>
			</div>
		</div>
		<?php endif ?>
